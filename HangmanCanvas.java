...
/** Resets the display so that only the scaffold appears */
	//note that these methods need to be public so that they can give and receive information from Hangman class
	public void reset() {
		
		drawScaffold();
	}
	
	//this method draws the initial scaffolding that is used at the start of the game
 ...
 */
	...
	//this method will create a label on the canvas that takes a string as a parameter
	//This parameter will be the hiddenWord (call this method from the Hangman class)
